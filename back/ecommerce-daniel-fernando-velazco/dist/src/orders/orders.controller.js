...
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    openapi.ApiResponse({ status: common_1.HttpStatus.OK, type: [require("../order-details/entities/order-detail.entity").OrdersDetail] }),
...
exports.OrdersController = OrdersController = __decorate([
    (0, swagger_1.ApiTags)('Orders-Swagger'),
